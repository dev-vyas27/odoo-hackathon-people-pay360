 ...
 *
 * Only an address. Nothing else is needed and nothing else should be accepted —
 * a `role` or `id` here would be a way to ask the endpoint questions about
 * accounts the caller has no business knowing about.
 */
